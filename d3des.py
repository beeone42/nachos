...
##  Ported to python3: (c) 2013 by Nikita Kovaliov
##
...
bytebit = [0o01, 0o02, 0o04, 0o010, 0o020, 0o040, 0o0100, 0o0200] # VNC version
...
def deskey(key, decrypt):      # Thanks to James Gillogly & Phil Karn!
    key = unpack('8B', bytearray(key, 'utf-8'))
...
if __name__ == '__main__':
  ...
  cipher = bytes.fromhex('6e09a37726dd560c')
  ek = deskey(key, decrypt=False)
  dk = deskey(key, decrypt=True)
